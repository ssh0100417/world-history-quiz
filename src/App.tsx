...
const QUESTION_BANK: Question[] = [...V0_QUESTION_BANK, ...V3_QUESTION_BANK];
...
const VERSION_OPTIONS: Array<Question['version']> = ['V0', 'V3'];
...
export default function App() {
  ...
  const [selectedVersions, setSelectedVersions] = useState<Array<Question['version']>>(['V0', 'V3']);
